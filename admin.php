...
if ($_SESSION['login'] != true) {
    header("Location: https://purple.greenriverdev.com/walnutridgewedding/Sprint5/login.php");
    exit();
} else if (!strstr($_SERVER['HTTP_REFERER'],"https://purple.greenriverdev.com/walnutridgewedding/Sprint5/login.php")) {
    header("Location: https://purple.greenriverdev.com/walnutridgewedding/Sprint5/login.php");
    exit();
