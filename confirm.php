...
if ($_SESSION['progress'] != 'four') {
    ...
    exit();
} else if (!strstr($_SERVER['HTTP_REFERER'],"https://purple.greenriverdev.com/walnutridgewedding/Sprint5/reserve.php")) {
    header("Location: https://purple.greenriverdev.com/walnutridgewedding/Sprint5/form.php");
    exit();
}
...
//check extras
$sqlExtras = "SELECT * FROM res_info INNER JOIN extras ON res_info.order_num=extras.order_num WHERE wed_date 
    BETWEEN '".$startDate->format('Y-m-d')."' AND '".$endDate->format('Y-m-d')."'";
$result = @mysqli_query($cnxn, $sqlExtras);
...
if ($num_rows > $_SESSION['dsbook']){
    echo '
            ...
            <div class="row">
                <div class="col-3"></div>
                <div class="col-6"
                    <h4>Uh oh! Someone reserved your set while you were shopping! Click the button below to start with a new date</h4>
    ...
    echo '
            ...
            <div class="row">
                <div class="col-3"></div>
                <div class="col-6"
                    <h4>Uh oh! Someone reserved one or more of your extras while you were shopping!</h4>
                    <p>Click the button below to start with a new date</p>
                    <a href="form.php" type="submit" class="btn btn-primary">Start over</a><br>
                </div>
                <div class="col-3"></div>
             </div>';
} else {
